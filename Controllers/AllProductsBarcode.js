...
const AllBracodeGetproducts = (io) => {
  io.on('connection', (socket) => {
    try {
      ...
      socket.on("GetIdss", async ({ id }) => {
        ...
        // 5. Send Response (Removed totalPages, currentPage, and slicing)
        socket.emit("AllGetproducts", {
          success: true,
...
module.exports = { AllBracodeGetproducts };